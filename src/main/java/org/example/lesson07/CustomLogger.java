...
public class CustomLogger implements WebDriverEventListener {
    ...
    public void beforeClickOn(WebElement webElement, WebDriver webDriver) {
        logger.info("Click on element with text: " + webElement.getText());
        Allure.step("Click on element with text: " + webElement.getText());

        Allure.addAttachment("Screenshot of page", new ByteArrayInputStream(
